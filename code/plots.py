...
def getNsaveRandomPredPlot(numeroMuestras,dfPred,pathOutput):
    ...
    plt.scatter(dfs.index, dfs.sf, c='red',s=100)
    plt.scatter(dfs.index, dfs.pred, c='blue',s=100)
    plt.plot(dfs.index, dfs.errorAbs, c='green',linestyle='solid',linewidth=6)
    ...
    plt.title('{} muestras aleatorias entre las {} predicciones. Valor de r2_score: {}'.format(numeroMuestras,dfPred.shape[0],r2_score(dfs.sf, dfs.pred)),fontsize=20)
